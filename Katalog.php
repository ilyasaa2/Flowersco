          ...
          >
            ...
            >
              ...
              <div class="absolute top-4 right-4">
                <button onclick="tambahFavorit('<?= htmlspecialchars($row['nama_produk']); ?>', '<?= $row['gambar']; ?>', '<?= $row['harga']; ?>', '<?= htmlspecialchars($row['kategori']); ?>')" class="w-10 h-10 bg-white/80 backdrop-blur-sm text-pink-600 rounded-full flex items-center justify-center hover:bg-white shadow-md transition-all">

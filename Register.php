...
<html lang="id">
  <head>
    ...
    />
    <style>
      /* Custom Scrollbar agar tetap estetik */
  ...
  <body class="bg-pink-50 min-h-screen flex items-center justify-center p-4">
    <div
      class="bg-white w-full max-w-4xl rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col md:flex-row h-[600px]"
    >
      <div class="md:w-1/2 relative hidden md:block h-full">
        <img
      ...
      <div class="md:w-1/2 p-8 md:p-10 flex flex-col h-full">
        <div class="mb-6">
        ...
        <div class="flex-grow overflow-y-auto pr-2 form-scrollbar">
          <form
          ...
          >
            ...
            <div>
              ...
              <div class="relative">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" id="eyeReg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                </button>
              </div>
              <div id="passwordError" class="text-[10px] text-red-500 mt-1 italic"></div>
            </div>

            <div>
              <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Konfirmasi Password</label>
              <div class="relative">
                <input
                  type="password"
                  id="confirmPassword"
                ...
                <button
                  ...
                  class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-pink-500"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" id="eyeConfirm" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                </button>
              </div>
              <div id="confirmError" class="text-[10px] text-red-500 mt-1 italic"></div>
            </div>
          </form>
        </div>
        ...
        <div class="mt-6">
          <button
            ...
            form="registerForm"
            name="register"
            class="w-full py-3 bg-[#d63384] text-white rounded-xl font-bold shadow-lg shadow-pink-100 hover:bg-pink-700 transition transform hover:-translate-y-0.5"
          >
            Daftar Sekarang
          </button>
          <p class="text-center mt-6 text-xs text-gray-500">
            Sudah punya akun?
            <a href="Login.php" class="text-[#d63384] font-bold hover:underline">Masuk di sini</a>
          </p>
        </div>
      </div>
    </div>

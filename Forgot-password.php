...
<body class="bg-pink-50 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white w-full max-w-4xl rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[600px]">
        <div class="md:w-1/2 relative hidden md:block">
            <img src="images/PinkRoseBouquet.jpg" alt="Forgot Password Background" class="absolute inset-0 w-full h-full object-cover" />
        ...
        <div class="md:w-1/2 p-10 lg:p-16 flex flex-col justify-center bg-white">
            ...
            <div class="text-center mt-10 space-y-2">
                <p class="text-xs text-gray-500">
                    Ingat password Anda? <a href="Login.php" class="text-[#d63384] font-bold hover:underline">Masuk</a>
                </p>
            </div>
        </div>
    </div>
